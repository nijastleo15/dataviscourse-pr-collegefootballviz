        ...
        yearSlider.on('input', function()
        {
            ...
            d3.csv("data/Project_Data.csv").then(school_data => {
                d3.csv("data/Coordinates.csv").then(coordinates => {
                    ...
                    that.scatterplot.updatePlot(school_data, this.value, that.selectedSchool, that.scatterplot.xIndicator, that.scatterplot.yIndicator, that.scatterplot.circleSizeIndicator);
